...
export const generateVerifyArtifactPayload = (
    ...
    const artifactJson = (artifactObj as { default: NoirCompiledContract }).default
...
export const generateVerifyArtifactUrl = (apiBaseUrl: string, contractClassId: string, version: number) =>
