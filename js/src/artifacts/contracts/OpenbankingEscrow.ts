...
export const OpenbankingEscrowContractArtifact = loadContractArtifact(
  OpenbankingEscrowContractArtifactJson as NoirCompiledContract
)
...
export class OpenbankingEscrowContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      OpenbankingEscrowContract.artifact,
      wallet
    ) as Promise<OpenbankingEscrowContract>
  }
  ...
  public static deployWithOpts<
    M extends keyof OpenbankingEscrowContract['methods'],
  >(
  ...
  public static get storage(): ContractStorageLayout<
    'config' | 'escrow_owners' | 'escrow_balances' | 'pubkey_registry'
  > {
    return {
      config: {
        slot: new Fr(1n),
  ...
  declare public methods: {
    ...
    add_key_hashes: ((key_hashes: FieldLike[]) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>

    /** check_verify_payload(payload: struct) */
    check_verify_payload: ((payload: {
      signature_limbs: FieldLike[]
      modulus_limbs: FieldLike[]
      redc_limbs: FieldLike[]
      partial_hash_start: (bigint | number)[]
      header_delimiter_index: bigint | number
      payload: (bigint | number)[]
      payload_length: bigint | number
    }) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>
    ...
    get_escrow_liqudity_position: ((
      commitment: FieldLike
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>

    /** get_escrow_liqudity_position_page(commitments: struct) */
    get_escrow_liqudity_position_page: ((commitments: {
      storage: FieldLike[]
      len: bigint | number
    }) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>
    ...
    get_escrow_owner_note: ((
      scope: AztecAddressLike
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>
    ...
    prompt_withdraw_escrow_balance: ((
      amount: U128Like
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>

    /** prove_payment_and_claim(openbanking_params: struct) */
    prove_payment_and_claim: ((openbanking_params: {
      signature_limbs: FieldLike[]
      modulus_limbs: FieldLike[]
      redc_limbs: FieldLike[]
      partial_hash_start: (bigint | number)[]
